...
const STEPS = [
  {
    ...
    body: "Type a single prompt into the box — a topic, a pitch, a lesson. That's the only input needed.",
  },
  {
    n: "02",
    title: "AI builds the show",
    body: "The script, the slide visuals and the narration are generated and stitched together automatically.",
  },
  {
    n: "03",
    title: "Watch & share",
    body: "Your presenter video plays instantly with synced voiceover. Replay it anytime from your library.",
  },
];
